...
filenames=(
  "$base_path/qa1_single-supporting-fact_1k.json"
  # "$base_path/qa2_two-supporting-facts_10k.json"
  # "$base_path/qa3_three-supporting-facts_10k.json"
  # "$base_path/qa4_two-arg-relations_10k.json"
  # "$base_path/qa5_three-arg-relations_10k.json"
  # "$base_path/qa6_yes-no-questions_10k.json"
  # "$base_path/qa7_counting_10k.json"
  # "$base_path/qa8_lists-sets_10k.json"
...
#    python  main.py --dataset_path=$file --seed=$seed
#    sleep 10
#  done
#done
